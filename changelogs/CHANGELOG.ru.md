...
### 🐛 Fix
- Исправить автоматическую аннотацию интерактивного опыта и конфигурации ({{commiturl}})
- Восстановить конфигурацию файла действий GitHub и исправить процесс кода ({{commiturl}})
- Исправьте логику отправки журналов передачи информации ({{commiturl}})
### ✨ Feature
- Может инициализировать pushTagMessage, отправить теги и генерировать журналы ({{commiturl}})
- Добавить информацию о отправке ({{commiturl}})
- В настоящее время функция завершена, а следующий шаг добавляется в скрипт действий GitHub, попробуйте вызвать ({{commiturl}})
- Идеальная функция, следующая ситуация переключателя конфигурации теста ({{commiturl}})
- Полная функция выпуска GitHub ({{commiturl}})
- Увеличьте функцию повторного генерации и очистки журнала ({{commiturl}})
### 🆕 Add
- Увеличение конфигурации и комментария Описание языкового пакета I18N ({{commiturl}})
- Добавить китайские и английские версии, которые настраивают i18n ({{commiturl}})
- Увеличить работу журналов ({{commiturl}})
- Добавлена ​​функция файла журнала, но она не была завершена ({{commiturl}})
### 🚧 Wip
- Функция сообщения журнала анализа выполняется ({{commiturl}})