...
### 🐛 Fix
- 修復交互式體驗和配置的自動註釋 ({{commiturl}})
- 還原github操作的文件配置，並糾正代碼過程 ({{commiturl}})
- 修復提交信息傳輸日誌的邏輯 ({{commiturl}})
### ✨ Feature
- 可以初始化PushTagMessage並提交標籤並生成日誌 ({{commiturl}})
- 添加提交信息 ({{commiturl}})
- 目前，該功能已經完成，下一步將添加到GitHub操作腳本中，嘗試調用 ({{commiturl}})
- 完美功能，下一個測試配置開關情況 ({{commiturl}})
- 完整的GitHub釋放功能 ({{commiturl}})
- 增加重新生成並清理日誌的功能 ({{commiturl}})
### 🆕 Add
- 增加了I18N語言包的配置和評論說明 ({{commiturl}})
- 添加配置I18N的中文和英文版本 ({{commiturl}})
- 增加日誌的操作 ({{commiturl}})
- 添加了日誌文件功能，但尚未完成 ({{commiturl}})
### 🚧 Wip
- 分析日誌消息函數已完成 ({{commiturl}})