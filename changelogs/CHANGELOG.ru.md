...
### 🐛 Fix
- Теперь он был изменен для чтения файла Log MD для публикации контента ([#4018681](https://github.com/kwooshung/cvlar/commit/4018681e1cc8cbc26a5a4d4ee228d67e83b9d6da))
- Исправить и добавить подсказки `changelog.template.content ([#0fd2175](https://github.com/kwooshung/cvlar/commit/0fd2175b24815703587a56f5b2f7c77786f9fa14))
- Вывод не выпущенные ([#a18c8d5](https://github.com/kwooshung/cvlar/commit/a18c8d50186a5d1cbd26c4636064644ae17cb1d2))
- Исправить последовательность сценария конфигурации действий GitHub ([#22a86ff](https://github.com/kwooshung/cvlar/commit/22a86ffacd0dc7dcfb60f2810bf7a51fb95d8128))
- Исправьте функцию удаления и отправьте информацию о временной файловой функции, чтобы избежать проблем, которые не существуют в объекте ([#60ee49f](https://github.com/kwooshung/cvlar/commit/60ee49f2891e950a82ce3c79eed41456676fb95d))
### 🆕 Add
- Метод для увеличения метода для получения тегов через API ([#8fdba13](https://github.com/kwooshung/cvlar/commit/8fdba13fd66ae44d66d7f97a24ef0aa1e56ad7ab))
### ✅ Test
- Добавить информацию отладки для легкой проверки ([#0d5f882](https://github.com/kwooshung/cvlar/commit/0d5f882fd156f02671a6239d43b4a3542701c347))
- Отладка и получить информацию о текущем списке релиза для тестирования ([#e63df25](https://github.com/kwooshung/cvlar/commit/e63df251835fbed961c2dfdb60c99f7057a5e362))

## 🎉 0.1.0-rc.6 `2023-12-30`
### 📦 Release
- Новая версия 0.1.0-RC.6 ([#8f3bd0d](https://github.com/kwooshung/cvlar/commit/8f3bd0d2980254207b6a0c4a41fc2b01a0128233))
### 🔄 Workflow
- Рабочий процесс, обновление версии автоматического выпуска ([#31f65ac](https://github.com/kwooshung/cvlar/commit/31f65acb40672453afd2981f9d007f162a27313e))
### 🐛 Fix
- Исправить процесс скрипта, чтобы избежать слишком низкой версии узла, что приводит к тому, что PNPM не может быть использован ([#db09ca2](https://github.com/kwooshung/cvlar/commit/db09ca227c3c5f401f0e1c76f77afa2990dae4a2))
- Избегайте тегов от отправки, и спросите еще раз, если вы отправите его, вызывая дубликаты вопросов ([#7a4fda6](https://github.com/kwooshung/cvlar/commit/7a4fda6bb499c62bfbe003b700eab602c7e750b9))
### ⚰ Remove
- Удалите временный файл GIT и проверьте, успешно ли он удален снова ([#90249e9](https://github.com/kwooshung/cvlar/commit/90249e92a37909adcc6155fed42e5a6825ae609a))

## 🎉 0.1.0-rc.5 `2023-12-30`
### 📦 Release
- Новая версия 0.1.0-RC.5 ([#1a9761d](https://github.com/kwooshung/cvlar/commit/1a9761d1aa483ae57c37749cb6fe8aef68cea70e))
### 🐛 Fix
- Изменить и добавить номер версии кода ([#b6cf54c](https://github.com/kwooshung/cvlar/commit/b6cf54ccbcae5723c162854334a264dd6da7142b))
- Исправить проблему специальной пустой строки result.emojior ([#524fa19](https://github.com/kwooshung/cvlar/commit/524fa194008adf7b6aba2ac37846ddd281213615))
...
### 🐛 Fix
- Перевод и Package. ([#0b5f906](https://github.com/kwooshung/cvlar/commit/0b5f90694c5cd27bae1906c33756cb86729b5ca1))
...
### 🆕 Add
- Увеличение конфигурации и описание комментариев языкового пакета I18N ([#26790de](https://github.com/kwooshung/cvlar/commit/26790de35cf9a1d41db1ea075356c37b018a1a46))
